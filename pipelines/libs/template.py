...
TASK
----
Given a C++ patch or code snippet (such as a git diff), extract one category of identifiers:
...
3. **Do not** prepend or append explanations such as “No identifiers were added.”  
